...
export function BottomNavigation() {
  ...
  const allItems: { label: string; route: '/' | '/explore' | '/bookings' | '/profile'; icon: React.ComponentProps<typeof Ionicons>['name'] }[] = [
  ...
  const items = isAuthenticated ? allItems : allItems.filter(item => item.label !== 'Profile');
